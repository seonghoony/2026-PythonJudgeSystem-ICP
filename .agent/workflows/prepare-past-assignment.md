...
- **Quotes:** Ensure proper directional quotes are used in LaTeX text (i.e. \`\` and '') instead of straight quotes (like ' or "), especially for string literals in the descriptions.
